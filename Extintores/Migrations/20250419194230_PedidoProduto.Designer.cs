...
namespace Extintores.Migrations
{
    ...
    [Migration("20250419194230_PedidoProduto")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Extintores.Model.Cliente", b =>
                {
                    b.Property<int>("Codigo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Extintores.Model.Pedido", b =>
                {
                    b.Property<int>("Codigo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Extintores.Model.PedidoProduto", b =>
                {
                    ...
                    b.HasKey("PedidoCodigo", "ProdutoCodigo");
            ...
            modelBuilder.Entity("Extintores.Model.Pedido", b =>
                {
                    b.HasOne("Extintores.Model.Cliente", "Cliente")
                        .WithMany()
            ...
            modelBuilder.Entity("Extintores.Model.PedidoProduto", b =>
                {
                    b.HasOne("Extintores.Model.Pedido", "Pedido")
                        .WithMany()
                        .HasForeignKey("PedidoCodigo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Extintores.Model.Produto", "Produto")
                        .WithMany()
